# Release Guide: v0.11.0 PyPI Publication
...
### Completed Items
- [x] Version updated to 0.11.0 in `pyproject.toml`
- [x] Version updated to 0.11.0 in `src/epydemics/__init__.py`
- [x] CHANGELOG.md entry added for v0.11.0
...
- [ ] Merge `copilot/prepare-pypi-release-v0-11-0` branch to `main`
- [ ] Create and push git tag `v0.11.0`
...
```bash
# Create annotated tag for v0.11.0
...
- 433/433 tests passing (100%)
- All 7 example notebooks validated
- Complete backward compatibility

Official PyPI release: pip install epydemics==0.11.0"
...
Visit: https://github.com/julihocc/epydemics/releases/new?tag=v0.11.0

**Release Title**: `Release v0.11.0: Production-Ready PyPI Publication`

**Release Notes** (use CHANGELOG.md content):

```markdown
# Release v0.11.0: Production-Ready PyPI Publication
...
- [README.md](https://github.com/julihocc/epydemics/blob/v0.11.0/README.md)
- [CHANGELOG.md](https://github.com/julihocc/epydemics/blob/v0.11.0/CHANGELOG.md)
- [Example Notebooks](https://github.com/julihocc/epydemics/tree/v0.11.0/examples/notebooks)
...
**Full Changelog**: https://github.com/julihocc/epydemics/compare/v0.10.0...v0.11.0
```
...
- **Solution**: Version already published, increment to v0.11.1 and retag
...
twine upload dist/epydemics-0.11.0*

# Upload to TestPyPI first (recommended for testing)
twine upload --repository testpypi dist/epydemics-0.11.0*
```
...
- [ ] PyPI page shows v0.11.0: https://pypi.org/project/epydemics/
- [ ] `pip install epydemics==0.11.0` works in clean virtualenv
- [ ] Imported package version is 0.11.0
- [ ] Basic import test passes: `from epydemics import DataContainer, Model`
- [ ] GitHub Release created with proper notes
- [ ] Release tagged in git: `git tag -l v0.11.0`
