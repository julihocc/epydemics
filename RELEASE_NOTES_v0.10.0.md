...
Version 0.10.0 introduces native annual frequency support with fractional recovery lag, enabling epidemiological modeling of eliminated diseases (measles, polio, rubella) with sporadic outbreak patterns.

### The Problem We Solved

**Before v0.10.0**: Using annual frequency with incidence mode failed with:
```
...
**After v0.10.0**: Beta varies naturally (0.038 to 1.0), VAR fits successfully, and forecasts work correctly.
...
- ✅ Updated notebook 06 with v0.10.0 API

## 🔄 Breaking Changes

**None**. Version 0.10.0 is fully backward compatible with v0.8.0.
...
# New approach (v0.10.0): Works natively
...
- 2 pre-existing visualization test failures (unrelated to v0.10.0 changes)
- See issue #141 for tracking

## 📦 Installation

```bash
pip install epydemics==0.10.0
```
...
- **Full Changelog**: [v0.8.0...v0.10.0](https://github.com/julihocc/epydemics/compare/v0.8.0...v0.10.0)
